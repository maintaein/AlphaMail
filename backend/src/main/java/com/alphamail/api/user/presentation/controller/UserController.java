...
public class UserController {
	...
	@PostMapping
	public ResponseEntity<Boolean> regist(@RequestBody RegistUserRequest registUserRequest) {
		return ResponseEntity.ok(registUserUseCase.execute(registUserRequest));
	}
